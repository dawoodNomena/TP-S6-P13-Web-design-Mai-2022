<div class="row">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h1>Liste des Solutions du rechauffement climatique</h1>
                  <h2><a href="<?php echo site_url('Welcome/pageInsertSolution');?>">Ajouter Solution</a></h2>
                      ...
                      <tbody>
                        ...
                        for($i=0; $i<count($liste); $i++) { ?>
                            <tr>
                                ...
                                <form action="<?php echo site_url('Welcome/supprSolution')?>" method="get">
